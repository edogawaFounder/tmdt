            ...
            <div class="row">
                ...
                <div class="col-2">
                    <div class="form-container">
                        ...
                        <form action="./page/xulydn.php" id="LoginForm" method="post">
                            <input type="text" id="username" placeholder="Tên tài khoản" name="username">
                        ...
                        <div id="RegForm">
                            ...
                            <div id="error2"></div>
                            <input type="text" id="name" placeholder="Tên người dùng" id="">
                            <div id="error3"></div>
        ...
        <script type="text/javascript">
            function checkFunction(){
                ...
                if(document.getElementById("user").value.length == 0){
                    document.getElementById("error1").innerHTML = "Vui lòng không để tên người dùng trống";
                } else{
                    document.getElementById("error1").innerHTML = "";
                }
                if(document.getElementById("pass").value.length == 0){
                    document.getElementById("error2").innerHTML = "Không để mật khẩu trống";
                } else{
