...
<?php if(isset($_SESSION['idsp'])){ ?>
                ...
                <td>
                    <div class="cart-info">
                        ...
                        <div>
                            ...
                            <br>
                            <a href="./page/test1.php?id=<?=$_SESSION['idsp'][$key]['idsp1'][$i]?>&size=<?=$_SESSION['idsp'][$key]['size'][$i]?>&color=<?=$_SESSION['idsp'][$key]['color'][$i]?>&quantity=<?=$_SESSION['idsp'][$key]['size'][$i]?>&index=<?=$i?>">Xóa</a>
                        </div>
                    </div>
                </td>
    ...
    <form action="index.php?action=dathang" method="post" class="orderform">
            ...
            <input type="submit" name="muahang" class="buybutton" value="">
    </form>
    <?php }  } else{ ?>
