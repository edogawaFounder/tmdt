                ...
                <td>
                    <div class="cart-info">
                        ...
                        <div>
                            ...
                            <br>
                            <a href="./page/test1.php?id=<?=$_SESSION['idsp'][$key]['idsp1'][$i]?>&size=<?=$_SESSION['idsp'][$key]['size'][$i]?>&color=<?=$_SESSION['idsp'][$key]['color'][$i]?>&quantity=<?=$_SESSION['idsp'][$key]['size'][$i]?>&tongtien=<?=$_SESSION['idsp'][$key]['tongtien'][$i]?>&index=<?=$i?>"></a>
                        </div>
                    </div>
                </td>
