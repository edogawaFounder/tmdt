            ...
            <div class="navbar">
                ...
                <nav>
                    <ul id="MenuItems">
                        ...
                        <li><a href="index.php?action=productclassification">Danh mục</a></li>
                        ...
                        <li>
                            <div class="dropdown">
                                ...
                                <div id="myDropdown" class="dropdown-content">
                                    ...
                                    <a href="index.php?action=history">Lịch sử mua</a>
                                    <a href="index.php?action=logout_user">Đăng xuất</a>
                                </div>
                            </div>
                        </li>
                        <?php } else{ ?>
