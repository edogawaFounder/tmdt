 ...
 <?php include("action.php");
    ...
    <div class="small-container">
        ...
        <div class="row row-2">
            ...
            <div>
                <a href="index.php?action=locnangcao">Lọc sản phẩm</a>
                <select id="sort" onchange="sortChanged(this)">
                    <option value="">Sắp xếp ....</option>
                    <option value="sort_increase">Theo tên(Từ A đến Z)</option>
                    <option value="sort_decrease">Theo tên(Từ Z đến A)</option>
                </select>
        ...
        <?php if(ceil($i1/8)>1){ ?>
        <h3  style="text-align:center;color:black;font-size:15px;">Có <?=ceil($i1/8);?> trang</h3>
        <?php } ?>
